...
| `pytest` | `9.1.1` | Test discovery and test runner for our 16 unit tests covering parser edge cases, injection defense, and NPS math. | Custom test runner using Python standard library `unittest`. | Development dependency only; zero production runtime footprint. |
